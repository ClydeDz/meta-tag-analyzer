...
export class AppConstants {
    ...
    readonly startingColumnNumber: number = 1;
    ...
    getMetadataTagsIncluded(): Array<MetadataTagsIncluded> {
        const metadataElements: MetadataTagsIncluded[] = new Array<MetadataTagsIncluded>();
        let columnPosition: number = this.startingColumnNumber;
        ...
        metadataElements.push(new MetadataTagsIncluded("og:description-length", "Open-graph description length",
            ++columnPosition, "propertyAttr"));
